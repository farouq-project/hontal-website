...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Operasi.id" },
      { property: "og:title", content: "Operasi.id" },
      { property: "og:description", content: "Produk, sistem custom, dan aktivasi bisnis untuk operasional Anda." },
